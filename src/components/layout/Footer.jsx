    ...
    >
      <div className="container">
        <div className="about">
          ...
          <p>
            <span>Email:</span>ritesh@gmail.com
          </p>
          <p>
            <span>Phone:</span>6386295980
          </p>
        </div>
      ...
      <div className="container">
        <div className="logo">My<span>BLOG</span></div>
        <p className="text-light">© 2024 My Blogs. Created with ❤️ by Ritesh Yadav</p>
